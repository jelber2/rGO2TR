...
#' acquiring mRNA accession identifiers, creating a gene ontology list, 
...
#' 
#' Also see the [README](https://github.com/jelber2/rGO2TR/blob/master/README.md)
...
#' sequences for the mRNA in FASTA format, \code{\link{upload.fasta.to.goanna}} -
#' uploads protein FASTA files to GOanna, and \code{\link{download.goanna.results}} - 
